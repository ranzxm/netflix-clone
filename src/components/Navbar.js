...
function Navbar() {
   return (
      <nav className="z-10 h-[86px] flex absolute top-0 left-0 right-0 ">
         <div className="con mx-5 xl:mx-32 lg:mx-14 sm:mx-5 xl:mx flex flex-shrink justify-between items-center w-full">
            <div className="logoss">
               <img src={netflixLogo} alt="" className="w-24 lg:w-40" />
            </div>
            <div className="wrap-lang-button flex justify-center items-center">
               <div className="lang-option flex bg-[#0f1212] items-center p rounded relative mx-3">
                  ...
                  <select
                     name="language"
                     id="language"
                     className="bg-[#0f1212] w-12 lg:w-full border-[1px] text-white pl-7 pr-3 py-[6px] rounded"
                  >
               ...
               <div className="sign-in">
                  <button className="bg-[#E50914] text-white px-[16px] py-[4px] font-bold rounded">Masuk</button>
               </div>
            </div>
         </div>
      </nav>
